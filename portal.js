...
async function initEnrollment(){
  ...
  const defaultQr={india:'',binance:'',paypal:'',pakistan:'',wise:''};
  ...
  document.getElementById('payMethod').onchange=updateQr;await updateQr();
